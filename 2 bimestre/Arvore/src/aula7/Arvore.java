...
public class Arvore {
	...
	/*
	 * Insere o nro mantendo os valores ordenados. A inserção será em uma
	 * subárvore do no
	 */
	...
	/*
	 * Remove o nó que possui o nro mantendo os valores ordenados. A busca será
	 * em uma subárvore do no
	 */
	public No remover(No no, int nro) {
		if (no == null) {
			...
			if (no.esquerdo == null && no.direito == null) {
				...
				/* nó tem os dois filhos */No aux = no.esquerdo;
